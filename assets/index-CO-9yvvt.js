...
`)+`
`+p);const b=y+m+a,T=y+p+o,w=vh(i,i.VERTEX_SHADER,b),E=vh(i,i.FRAGMENT_SHADER,T);i.attachShader(x,w),i.attachShader(x,E),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function A(C){if(r.debug.checkShaderErrors){const F=i.getProgramInfoLog(x)||"",B=i.getShaderInfoLog(w)||"",X=i.getShaderInfoLog(E)||"",G=F.trim(),W=B.trim(),Y=X.trim();let V=!0,ee=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(V=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,x,w,E);else{const te=yh(i,w,"vertex"),xe=yh(i,E,"fragment");Be("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
</div>`,YM=Object.freeze(Object.defineProperty({__proto__:null,default:qM},Symbol.toStringTag,{value:"Module"})),jM=`<div class="grid grid-cols-[2fr_1fr] w-full h-full">
    <div class="relative border-bg-card pt-8 border-r h-full flex flex-col">
        <div class="absolute top-0 left-0 border-l-2 border-t-2 border-primary w-4 h-4"></div>
...
</div>`,ZM=Object.freeze(Object.defineProperty({__proto__:null,default:$M},Symbol.toStringTag,{value:"Module"})),JM="/threejsportfolio/assets/prorer1-fE4xLF43.jpeg",QM=Object.freeze(Object.defineProperty({__proto__:null,default:JM},Symbol.toStringTag,{value:"Module"})),eS="/threejsportfolio/assets/prorer2-DdZDB9on.jpeg",tS=Object.freeze(Object.defineProperty({__proto__:null,default:eS},Symbol.toStringTag,{value:"Module"})),nS="/threejsportfolio/assets/prorer3-CZyTW0Qp.jpeg",iS=Object.freeze(Object.defineProperty({__proto__:null,default:nS},Symbol.toStringTag,{value:"Module"})),rS="/threejsportfolio/assets/prorer4-D0B-0BmB.jpeg",sS=Object.freeze(Object.defineProperty({__proto__:null,default:rS},Symbol.toStringTag,{value:"Module"})),rf=["!","@","#","$","%","^","&","*","(",")","-","_","+","=","{","}","[","]","|","\\",":",";",'"',"'","<",">",",",".","?","/"];async function Oa(r,e){const t=document.getElementById(e);if(!t)return;const n=1e3,i=Date.now();return new Promise(s=>{function a(){const l=Date.now()-i,c=Math.min(l/n,1),u=Math.floor(c*r.length),h=r.slice(0,u);if(c>=1){t.textContent=r,s();return}const f=r.length-u;let d="";for(let g=0;g<f;g++)d+=rf[Math.floor(Math.random()*rf.length)];t.textContent=h+d,requestAnimationFrame(a)}requestAnimationFrame(a)})}const fc=new I0;let Nr,ar={abortBoot:null,screenMeshMaterial:null,isOnDesktop:!1},ln=ar.isOnDesktop,Ja={state:!1};function aS(r,e,t,n,i,s,a={}){return jd(a),a.resize=()=>window.existingResizeHandler(e,i),a.click=o=>window.existingClickHandler(o,r,i),a.controlLock=()=>cS(r),a.beforeUnload=()=>Hf(n,i,r),a.toggleDesktop=()=>hS(e,t,r),a.mousemove=o=>uS(o,s),a.loaded=()=>oS(),window.addEventListener("resize",a.resize,!1),window.addEventListener("click",a.click,!1),document.addEventListener("click",a.controlLock),document.addEventListener("beforeunload",a.beforeUnload),window.addEventListener("toggle-desktop",a.toggleDesktop),window.addEventListener("mousemove",a.mousemove),window.addEventListener("threejs-loaded",a.loaded),fS(),a}async function oS(){const r=document.getElementById("loading-screen");r.classList.add("opacity-0"),await Dn(800),r.remove(),lS()}async function lS(){await Dn(1500),document.getElementById("toast").classList.remove("translate-x-full"),document.getElementById("countdown").classList.add("animate-toast"),await Dn(400),Oa("You are here to leak redacted data. Make it quick.","transmission"),document.getElementById("countdown").addEventListener("animationend",r=>{const e=r.target.parentElement;e.classList.add("translate-x-full"),setTimeout(()=>e.remove(),800)})}function jd(r){window.existingLoopId&&cancelAnimationFrame(window.existingLoopId),ar.abortBoot&&(ar.abortBoot.abort(),ar.abortBoot=null);const e=document.querySelector("canvas");if(e&&e.remove(),r){r.resize&&window.removeEventListener("resize",r.resize),r.click&&window.removeEventListener("click",r.click),r.controlLock&&document.removeEventListener("click",r.controlLock),r.beforeUnload&&document.removeEventListener("beforeunload",r.beforeUnload),r.toggleDesktop&&window.removeEventListener("toggle-desktop",r.toggleDesktop),r.mousemove&&window.removeEventListener("mousemove",r.mousemove),r.loaded&&window.removeEventListener("threejs-loaded",r.loaded);for(const t in r)delete r[t]}}window.existingResizeHandler=function(r,e){window.innerWidth<1024&&(window.location.href="access_denied.html"),r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),e.setSize(window.innerWidth,window.innerHeight),e.setPixelRatio(Math.min(window.devicePixelRatio,2))};window.existingClickHandler=function(r,e,t){if(!e.isLocked&&!ln||r.target!=t.domElement||Ja.state)return;const n=fc.intersectObjects(rs,!0);if(n.length>0){const i=n[0].object;i.userData.onClick&&i.userData.onClick(ar)}};function cS(r){ln||r.lock()}function uS(r,e){e.rawX=r.clientX,e.rawY=r.clientY,ln?(e.x=r.clientX/window.innerWidth*2-1,e.y=-(r.clientY/window.innerHeight*2-1)):(e.x=0,e.y=0)}async function hS(r,e,t){ln=!ln,ar.abortBoot=null,Ja.state=!0,Nr=null,ln?(so(),t.unlock()):(await Yd(ar.screenMeshMaterial,!0),t.lock()),Ub(ln),UM(r,e,ln,Ja)}function fS(){document.getElementById("xButton").addEventListener("click",()=>Zd.closePage())}function dS(r,e){if(Ja.state||window.isOnSlide)return;fc.setFromCamera(r,e);const t=fc.intersectObjects(rs.filter(n=>n.visible));if(t.length>0){const n=t[0].object;if(n===Nr){if(!ln)return;so(),nf(ln,n,r);return}ln&&qd(n),Nr=n,nf(ln,n,r)}else Nr!=null&&(Kd(),Nr=null)}function Kd(){ln&&qd(Nr,!0),so()}const pS={PRorER:{redacted:!0,title:"PRorER",short_bio:"Workout Logger and Optimizer",bio:"A sophistacted application that's designed to offer gym goers a free method to categorize, log and graph their workouts and personal records (PRs). Built using Flutter, Postgres, S3 Buckets and SupabaseAuth.",stack:["FLUTTER","FRONT-END","BACK-END","DB-ARCH","UI/UX"],source_btn:null,initialize:"unimplemented.html"}};async function $d(r,e,...t){const n=document.getElementById(r);let i=t.indexOf(n.textContent);i=i==-1?0:i;const s=t[(i+1)%t.length];n.textContent=s,n.setAttribute("data-text",s),await Dn(e),requestAnimationFrame(()=>$d(r,e,...t))}const mS=Object.assign({"/src/pages/About Me.html":YM}),xS=Object.assign({"/src/template-allowed.html":KM,"/src/template-redacted.html":ZM}),gS=Object.assign({"/src/PRorER/prorer1.jpeg":QM,"/src/PRorER/prorer2.jpeg":tS,"/src/PRorER/prorer3.jpeg":iS,"/src/PRorER/prorer4.jpeg":sS});function sf(){const r=document.getElementById("slide");r.classList.contains("translate-y-full")?r.classList.remove("translate-y-full"):r.classList.add("translate-y-full")}function _S(r){let t=Object.entries(mS).find(([n,i])=>n.split("/").at(-1).split(".")[0]===r);return t===void 0?yS(r):[null,t[1].default]}async function vS(r){r==="About Me"?(await Dn(450),Oa("In a world where everything is locked behind a micro transaction, people yearn for safety and silence. His mission is to bring that back to reality.","bio")):(await Dn(450),Oa("[ SYNOPSIS ]","synopsis"),Oa("[ STACK ]","stack"))}function bS(){$d("redacted",2500,"CORRUPTED","UNKNOWN","0x_ERROR")}function yS(r){const t=Object.entries(pS).find(s=>s[0]==r);if(t==null)throw Error("Page not found");const n=t[1],i=Object.entries(xS);return n.redacted?[n,i.find(s=>s[0].includes("redacted"))[1].default]:[n,i.find(s=>s[0].includes("allowed"))[1].default]}function MS(r){const e=[];Object.entries(gS).forEach(([s,a])=>{s.includes(r)&&e.push(a.default)});const n=document.getElementById("carousel"),i=document.getElementById("img");i.setAttribute("src",e[0]),e.shift();for(const[s,a]of e.entries()){const o=i.cloneNode();o.setAttribute("src",a),o.setAttribute("id",s),n.append(o)}SS()}function SS(){const r=document.getElementById("carousel"),e=document.getElementById("closeimg");e.onclick=()=>{const t=document.getElementById("img-slide");t.classList.remove("-translate-y-1/2"),t.classList.add("translate-y-full")},r.onclick=t=>{const n=t.target;if(console.log(t.target.tagName),t.target.tagName!="IMG")return;const i=document.getElementById("img-slide");document.getElementById("slide image").setAttribute("src",n.getAttribute("src")),i.classList.remove("translate-y-full"),i.classList.add("-translate-y-1/2")}}function TS(r){const e=Object.entries(r),t=document.createElement("p");t.className="font-mono text-xs text-text-muted mb-2 select-none",t.textContent="[CLASSIFIED]";for(const[n,i]of e){if(n==="redacted"){i&&bS();continue}if(n==="initialize")if(i){document.getElementById("initialize").setAttribute("href",i);continue}else{document.getElementById("initialize").remove(),document.getElementById("title-container").prepend(t);continue}if(i){if(n==="stack"){for(const[s,a]of i.entries())document.getElementById(`stack-${s+1}`).textContent=a;continue}if(n=="source_btn"){document.getElementById(n).setAttribute("href",i);continue}document.getElementById(n).textContent=i}}}const Zd={openPage(r){window.isOnSlide=!0,Kd();const[e,t]=_S(r),n=document.getElementById("pageContainer");n.innerHTML=t,sf(),e&&(MS(r),TS(e)),vS(r)},closePage(){sf(),window.isOnSlide=!1}},ES=Object.assign({"/src/icons/About Me.png":VM,"/src/icons/PRorER.png":HM,"/src/icons/Power.png":XM});function*wS(){const r=Object.values(ES);PS(r);for(const[e,t]of r.entries()){const n=t.default,i=n.split("/").at(-1).split(".")[0],s=new Dc().load(n),a=22,o=AS(i,s,a);o.userData.isIcon=!0,o.userData.onClick=CS(i.replaceAll("%20"," ")),o.name=i;const[l,c]=RS(e,15,a,4);o.position.set(l,-17,c),o.visible=!1,o.userData.scaleTween=LS(o,1,1.2),yield o}}function AS(r,e,t){const n=new to({color:9553841,map:e,emissiveMap:e,emissive:16777215,emissiveIntensity:.75}),i=new hr(t,t,t),s=new Qt(i,n);return s.name=r,s}function RS(r,e,t,n){const a=e+t,l=220-a*(r%n);return[Math.floor(r/n)*a+-135,l]}function CS(r){return r==="Power"?()=>window.dispatchEvent(new CustomEvent("toggle-desktop")):()=>Zd.openPage(r)}function PS(r){const e=r.indexOf(n=>n.default.contains("Power")),t=r.splice(e,1)[0];r.push(t)}function LS(r,e,t){return cr.fromTo(r.scale,{x:e,z:e},{paused:!0,x:t,z:t,overwrite:"auto"})}const rs=[];let Jd,Ds=rs.filter(r=>r.userData.isIcon),Is=Ds.map(r=>r.scale);function DS(r){const e=Object.values(kM);for(const t of e)typeof t=="function"&&rs.push(t(r));for(const t of wS())rs.push(t),Wf(r,t,Oc);Jd=US()}async function Qd(){Is.some(r=>r.x>0)?await IS():await Jd.restart()}async function IS(){await cr.to(Is,{x:0,y:0,z:0,duration:1,stagger:.1,ease:"power3.inOut",onComplete:()=>{Ds.forEach(r=>r.visible=!1)}})}function US(){return Ds=rs.filter(e=>e.userData.isIcon),Is=Ds.map(e=>e.scale),cr.set(Is,{x:0,y:0,z:0}),cr.to(Is,{x:1,y:1,z:1,paused:!0,duration:1,stagger:.1,ease:"back.out(1.7)",onStart:()=>{Ds.forEach(e=>e.visible=!0)}})}let ri;function NS(r,e){new Xf(e).load("models/personal_computer/pc.glb",function(n){const i=n.scene.children[0];i.name=Oc,i.position.set(-7.9,.35,-1.87),i.rotation.z=-Math.PI/2,r.add(i),Gf(i),i.traverse(s=>{s.isMesh&&s.material.name==="Screen"&&VS(s)}),DS(r)})}async function FS(){const r=document.createElement("canvas"),e=r.getContext("2d");Ib(r);const t=new t0(r);ri.color=new Ae(16777215),ri.emissive=new Ae(16777215),ri.map.dispose(),ri.map=t,ri.emissiveMap=t,t.colorSpace=Ct,t.flipY=!1,t.anisotropy=16,iu(r),e.fillStyle="white",t.magFilter=Dt,t.minFilter=Dt,e.imageSmoothingEnabled=!1,e.font=`${Wa}px VT323`;const n=new AbortController;return t.needsUpdate=!0,OS(t,e,r,n),[n,ri]}async function OS(r,e,t,n){const i=[];let s=14,a=qo[0];e.fillText(a,50,Wa+10),r.needsUpdate=!0,i.push({line:a,color:e.fillStyle});for(let o=0;o<qo.length;o++){if(await Dn(100+Math.random()*2e3),n.signal.aborted)return;let l=qo[o];o>=s&&(i.shift(),ep(e,t,i));const c=GS(l,e);e.fillText(l,50,(Wa+10)*Math.min(o+1,s)),i.push({line:l,color:e.fillStyle}),r.needsUpdate=!0,await Dn(c)}BS(e,t,i,r,n)}function ep(r,e,t){iu(e);for(let n=0;n<t.length;n++){let i=t[n];r.fillStyle=i.color,r.fillText(i.line,50,(Wa+10)*n+1)}}async function BS(r,e,t,n,i){let s=!1;for(let a=0;a<5;a++){if(await Dn(500),i.signal.aborted)return;s=!s,t[t.length-1]={line:`> ${s?"█":"_"}`,color:"white"},ep(r,e,t),n.needsUpdate=!0}kS(r,e,n,i)}async function kS(r,e,t,n){if(n.signal.aborted)return;iu(e),r.fillStyle="white";let i="Loading StrikeOS...",s=r.measureText(i).width;r.textAlign="center",r.fillText(i,e.width/2,e.height/2),r.strokeStyle="cyan",r.lineWidth=5,r.strokeRect(e.width/2-s/2,e.height/2+50,s,80),t.needsUpdate=!0,r.fillStyle="cyan";let a=0;for(let o=1;o<=10;o++){if(await Dn(500*Math.random()),n.signal.aborted)return;a=o/10*s,r.fillRect(e.width/2-s/2,e.height/2+50,a,80),t.needsUpdate=!0}await zS()}async function zS(){const r=await new Dc().loadAsync("/pictures/pic.jpg");r.flipY=!1,ri.map=r,ri.emissiveMap=r,Qd(),window.dispatchEvent(new CustomEvent("toggle-desktop"))}function VS(r){const e=new St,t=new Un({map:e,emissiveMap:e,emissive:0,emissiveIntensity:.3,color:0,side:En,clearcoat:.5});r.material=t,ri=t}function GS(r,e){switch(r.slice(3,r.indexOf("]"))){case"WARN":return e.fillStyle="#ff9100ff",700;case"CRIT":return e.fillStyle="red",700;case"FIX":return e.fillStyle="green",0;default:return e.fillStyle="white",0}}function iu(r){const e=r.getContext("2d");e.fillStyle="black",e.fillRect(0,0,r.width,r.height)}function HS(r,e){new Xf(e).load("models/empty_office_space/office.glb",function(n){const i=n.scene;i.position.set(-8.2,-.5,-1.7),r.add(i),Gf(i)})}function WS(r,e,t,n,i){r.background=new Ae(11184810),e.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(e.domElement),t.movementSpeed=0,t.lookSpeed=.1,t.maxPolarAngle=Math.PI*3/4,t.minPolarAngle=Math.PI/4;const s=new Ff(16777215,1);s.position.set(0,10,-2);const a=new x0(16777215,16777215);a.position.set(0,10,0),r.add(s),r.add(a),r.add(i),n.position.set(-8.97,.8,-1.95),i.lookAt(Bc.desktopLookVector),n.lookAt(-7.9,.8,-1.87)}let Ki,dc,$i,Qi,Aa,rl;const Rn="__THREE_APP_CONTEXT__";if(window[Rn]){console.log("Cleaning up previous context...");const r=window[Rn];r.loopId&&cancelAnimationFrame(r.loopId),jd(r.listeners),IM(),Hf(r.scene,r.renderer,r.controls,r.gui),window[Rn]=null}window[Rn]={renderer:null,scene:null,camera:null,controls:null,loopId:null,listeners:{}};XS();async function XS(){Ki=new yb({antialias:!0}),window[Rn].renderer=Ki,Ki.setPixelRatio(Math.min(window.devicePixelRatio,2)),dc={x:0,y:0,rawX:0,rawY:0},$i=new Gm,window[Rn].scene=$i,Qi=new Ft(75,window.innerWidth/window.innerHeight,.1,1e3),window[Rn].camera=Qi,Aa=new Eb(Qi,Ki.domElement),window[Rn].controls=Aa,rl=NM(Bc.desktopLocationVector),aS(Aa,Qi,rl,$i,Ki,dc,window[Rn].listeners),tp(),await Pb(),WS($i,Ki,Aa,Qi,rl);const r=new Uf;r.onLoad=function(){window.dispatchEvent(new CustomEvent("threejs-loaded"))},HS($i,r),NS($i,r)}function tp(){dS(dc,Qi),Ki.render($i,Qi);const r=requestAnimationFrame(tp);window[Rn]&&(window[Rn].loopId=r)}async function pc(r,e,t){const n=document.getElementById(e);if(!n)return;const i=n.textContent.split("").filter(s=>s==".").length;if(await Dn(500),i===r||t&&i!=0){n.textContent=n.textContent.replace(".",""),pc(r,e,!0);return}n.textContent=n.textContent+".",pc(r,e)}pc(3,"loading-text");const np=document.getElementById("hitmarkerText");np.style.backdropFilter="blur(4px)";np.style.backgroundColor="rgba(59, 59, 59, 0.9)";
