...
#endif`,mx="gl_FragColor = linearToOutputTexel( gl_FragColor );",xx=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function C_(r,e,t){const n=new Float32Array(Ji),i=new N(0,1,0);return new hi({name:"SphericalGaussianBlur",defines:{n:Ji,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:io(),fragmentShader:`
	...
	`}function P_(r){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===pl||l===ml,u=l===Wr||l===Xr;if(c||u){let h=e.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new lh(r)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const d=o.image;return c&&d&&d.height>0||u&&d&&i(d)?(t===null&&(t=new lh(r)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function i(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function L_(r){const e={};function t(n){if(e[n]!==void 0)return e[n];const i=r.getExtension(n);return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Vs("WebGLRenderer: "+n+" extension not supported."),i}}}function D_(r,e,t,n){const i={},s=new WeakMap;function a(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete i[f.id];const d=s.get(f);d&&(e.remove(d),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return i[f.id]===!0||(f.addEventListener("dispose",a),i[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const d in f)e.update(f[d],r.ARRAY_BUFFER)}function c(h){const f=[],d=h.index,g=h.attributes.position;let x=0;if(d!==null){const y=d.array;x=d.version;for(let b=0,T=y.length;b<T;b+=3){const w=y[b+0],E=y[b+1],A=y[b+2];f.push(w,E,E,A,A,w)}}else if(g!==void 0){const y=g.array;x=g.version;for(let b=0,T=y.length/3-1;b<T;b+=3){const w=b+0,E=b+1,A=b+2;f.push(w,E,E,A,A,w)}}else return;const m=new(vf(f)?Sf:Mf)(f,1);m.version=x;const p=s.get(h);p&&e.remove(p),s.set(h,m)}function u(h){const f=s.get(h);if(f){const d=h.index;d!==null&&f.version<d.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function I_(r,e,t){let n;function i(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,d){r.drawElements(n,d,s,f*a),t.update(d,n,1)}function c(f,d,g){g!==0&&(r.drawElementsInstanced(n,d,s,f*a,g),t.update(d,n,g))}function u(f,d,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,s,f,0,g);let m=0;for(let p=0;p<g;p++)m+=d[p];t.update(m,n,1)}function h(f,d,g,x){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<f.length;p++)c(f[p]/a,d[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(n,d,0,s,f,0,x,0,g);let p=0;for(let y=0;y<g;y++)p+=d[y]*x[y];t.update(p,n,1)}}this.setMode=i,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function U_(r){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case r.TRIANGLES:t.triangles+=o*(s/3);break;case r.LINES:t.lines+=o*(s/2);break;case r.LINE_STRIP:t.lines+=o*(s-1);break;case r.LINE_LOOP:t.lines+=o*s;break;case r.POINTS:t.points+=o*s;break;default:Be("WebGLInfo: Unknown draw mode:",a);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function N_(r,e,t){const n=new WeakMap,i=new Qe;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==h){let _=function(){A.dispose(),n.delete(o),o.removeEventListener("dispose",_)};f!==void 0&&f.texture.dispose();const d=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,x=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let b=0;d===!0&&(b=1),g===!0&&(b=2),x===!0&&(b=3);let T=o.attributes.position.count*b,w=1;T>e.maxTextureSize&&(w=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const E=new Float32Array(T*w*4*h),A=new bf(E,T,w,h);A.type=Cn,A.needsUpdate=!0;const P=b*4;for(let M=0;M<h;M++){const L=m[M],F=p[M],B=y[M],G=T*w*4*M;for(let X=0;X<L.count;X++){const H=X*P;d===!0&&(i.fromBufferAttribute(L,X),E[G+H+0]=i.x,E[G+H+1]=i.y,E[G+H+2]=i.z,E[G+H+3]=0),g===!0&&(i.fromBufferAttribute(F,X),E[G+H+4]=i.x,E[G+H+5]=i.y,E[G+H+6]=i.z,E[G+H+7]=0),x===!0&&(i.fromBufferAttribute(B,X),E[G+H+8]=i.x,E[G+H+9]=i.y,E[G+H+10]=i.z,E[G+H+11]=B.itemSize===4?i.w:1)}}f={count:h,texture:A,size:new je(T,w)},n.set(o,f),o.addEventListener("dispose",_)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(r,"morphTexture",a.morphTexture,t);else{let d=0;for(let x=0;x<c.length;x++)d+=c[x];const g=o.morphTargetsRelative?1:1-d;l.getUniforms().setValue(r,"morphTargetBaseInfluence",g),l.getUniforms().setValue(r,"morphTargetInfluences",c)}l.getUniforms().setValue(r,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(r,"morphTargetsTextureSize",f.size)}return{update:s}}function F_(r,e,t,n){let i=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(i.get(h)!==c&&(e.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(t.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;i.get(f)!==c&&(f.update(),i.set(f,c))}return h}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}const Bf=new St,fh=new Pf(1,1),kf=new bf,zf=new Em,Vf=new wf,dh=[],ph=[],mh=new Float32Array(16),xh=new Float32Array(9),gh=new Float32Array(4);function cs(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let s=dh[i];if(s===void 0&&(s=new Float32Array(i),dh[i]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,r[a].toArray(s,o)}return s}function wt(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function At(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function ro(r,e){let t=ph[e];t===void 0&&(t=new Int32Array(e),ph[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function O_(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function B_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;r.uniform2fv(this.addr,e),At(t,e)}}function k_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(wt(t,e))return;r.uniform3fv(this.addr,e),At(t,e)}}function z_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;r.uniform4fv(this.addr,e),At(t,e)}}function V_(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;gh.set(n),r.uniformMatrix2fv(this.addr,!1,gh),At(t,n)}}function G_(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;xh.set(n),r.uniformMatrix3fv(this.addr,!1,xh),At(t,n)}}function H_(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;mh.set(n),r.uniformMatrix4fv(this.addr,!1,mh),At(t,n)}}function W_(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function X_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;r.uniform2iv(this.addr,e),At(t,e)}}function q_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;r.uniform3iv(this.addr,e),At(t,e)}}function Y_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;r.uniform4iv(this.addr,e),At(t,e)}}function j_(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function K_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;r.uniform2uiv(this.addr,e),At(t,e)}}function $_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;r.uniform3uiv(this.addr,e),At(t,e)}}function Z_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;r.uniform4uiv(this.addr,e),At(t,e)}}function J_(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(fh.compareFunction=_f,s=fh):s=Bf,t.setTexture2D(e||s,i)}function Q_(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||zf,i)}function ev(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Vf,i)}function tv(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||kf,i)}function nv(r){switch(r){case 5126:return O_;case 35664:return B_;case 35665:return k_;case 35666:return z_;case 35674:return V_;case 35675:return G_;case 35676:return H_;case 5124:case 35670:return W_;case 35667:case 35671:return X_;case 35668:case 35672:return q_;case 35669:case 35673:return Y_;case 5125:return j_;case 36294:return K_;case 36295:return $_;case 36296:return Z_;case 35678:case 36198:case 36298:case 36306:case 35682:return J_;case 35679:case 36299:case 36307:return Q_;case 35680:case 36300:case 36308:case 36293:return ev;case 36289:case 36303:case 36311:case 36292:return tv}}function iv(r,e){r.uniform1fv(this.addr,e)}function rv(r,e){const t=cs(e,this.size,2);r.uniform2fv(this.addr,t)}function sv(r,e){const t=cs(e,this.size,3);r.uniform3fv(this.addr,t)}function av(r,e){const t=cs(e,this.size,4);r.uniform4fv(this.addr,t)}function ov(r,e){const t=cs(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function lv(r,e){const t=cs(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function cv(r,e){const t=cs(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function uv(r,e){r.uniform1iv(this.addr,e)}function hv(r,e){r.uniform2iv(this.addr,e)}function fv(r,e){r.uniform3iv(this.addr,e)}function dv(r,e){r.uniform4iv(this.addr,e)}function pv(r,e){r.uniform1uiv(this.addr,e)}function mv(r,e){r.uniform2uiv(this.addr,e)}function xv(r,e){r.uniform3uiv(this.addr,e)}function gv(r,e){r.uniform4uiv(this.addr,e)}function _v(r,e,t){const n=this.cache,i=e.length,s=ro(t,i);wt(n,s)||(r.uniform1iv(this.addr,s),At(n,s));for(let a=0;a!==i;++a)t.setTexture2D(e[a]||Bf,s[a])}function vv(r,e,t){const n=this.cache,i=e.length,s=ro(t,i);wt(n,s)||(r.uniform1iv(this.addr,s),At(n,s));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||zf,s[a])}function bv(r,e,t){const n=this.cache,i=e.length,s=ro(t,i);wt(n,s)||(r.uniform1iv(this.addr,s),At(n,s));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Vf,s[a])}function yv(r,e,t){const n=this.cache,i=e.length,s=ro(t,i);wt(n,s)||(r.uniform1iv(this.addr,s),At(n,s));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||kf,s[a])}function Mv(r){switch(r){case 5126:return iv;case 35664:return rv;case 35665:return sv;case 35666:return av;case 35674:return ov;case 35675:return lv;case 35676:return cv;case 5124:case 35670:return uv;case 35667:case 35671:return hv;case 35668:case 35672:return fv;case 35669:case 35673:return dv;case 5125:return pv;case 36294:return mv;case 36295:return xv;case 36296:return gv;case 35678:case 36198:case 36298:case 36306:case 35682:return _v;case 35679:case 36299:case 36307:return vv;case 35680:case 36300:case 36308:case 36293:return bv;case 36289:case 36303:case 36311:case 36292:return yv}}class Sv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=nv(t.type)}}class Tv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Mv(t.type)}}class Ev{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let s=0,a=i.length;s!==a;++s){const o=i[s];o.setValue(e,t[o.id],n)}}}const Xo=/(\w+)(\])?(\[|\.)?/g;function _h(r,e){r.seq.push(e),r.map[e.id]=e}function wv(r,e,t){const n=r.name,i=n.length;for(Xo.lastIndex=0;;){const s=Xo.exec(n),a=Xo.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){_h(t,c===void 0?new Sv(o,r,e):new Tv(o,r,e));break}else{let h=t.map[o];h===void 0&&(h=new Ev(o),_h(t,h)),t=h}}}class Ia{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=e.getActiveUniform(t,i),a=e.getUniformLocation(t,s.name);wv(s,a,this)}}setValue(e,t,n,i){const s=this.map[t];s!==void 0&&s.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,s=e.length;i!==s;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function vh(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const Av=37297;let Rv=0;function Cv(r,e){const t=r.split(`
`),n=[],i=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=i;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const bh=new Ne;function Pv(r){$e._getMatrix(bh,$e.workingColorSpace,r);const e=`mat3( ${bh.elements.map(t=>t.toFixed(4))} )`;switch($e.getTransfer(r)){case ka:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return ve("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function yh(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),s=(r.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+s+`

`+Cv(r.getShaderSource(e),o)}else return s}function Lv(r,e){const t=Pv(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Dv(r,e){let t;switch(e){case Np:t="Linear";break;case Fp:t="Reinhard";break;case Op:t="Cineon";break;case Bp:t="ACESFilmic";break;case zp:t="AgX";break;case Vp:t="Neutral";break;case kp:t="Custom";break;default:ve("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ea=new N;function Iv(){$e.getLuminanceCoefficients(Ea);const r=Ea.x.toFixed(4),e=Ea.y.toFixed(4),t=Ea.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Uv(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ss).join(`
`)}function Nv(r){const e=[];for(const t in r){const n=r[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Fv(r,e){const t={},n=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(e,i),a=s.name;let o=1;s.type===r.FLOAT_MAT2&&(o=2),s.type===r.FLOAT_MAT3&&(o=3),s.type===r.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:r.getAttribLocation(e,a),locationSize:o}}return t}function Ss(r){return r!==""}function Mh(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Sh(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Ov=/^[ \t]*#include +<([\w\d./]+)>/gm;function Kl(r){return r.replace(Ov,kv)}const Bv=new Map;function kv(r,e){let t=Oe[e];if(t===void 0){const n=Bv.get(e);if(n!==void 0)t=Oe[n],ve('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Kl(t)}const zv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Th(r){return r.replace(zv,Vv)}function Vv(r,e,t,n){let i="";for(let s=parseInt(e);s<parseInt(t);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Eh(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}function Gv(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===af?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===pp?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===ti&&(e="SHADOWMAP_TYPE_VSM"),e}function Hv(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Wr:case Xr:e="ENVMAP_TYPE_CUBE";break;case Qa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Wv(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Xr:e="ENVMAP_MODE_REFRACTION";break}return e}function Xv(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case of:e="ENVMAP_BLENDING_MULTIPLY";break;case Ip:e="ENVMAP_BLENDING_MIX";break;case Up:e="ENVMAP_BLENDING_ADD";break}return e}function qv(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Yv(r,e,t,n){const i=r.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Gv(t),c=Hv(t),u=Wv(t),h=Xv(t),f=qv(t),d=Uv(t),g=Nv(s),x=i.createProgram();let m,p,y=t.glslVersion?"#version "+t.glslVersion+`
...
</div>`,KM=Object.freeze(Object.defineProperty({__proto__:null,default:jM},Symbol.toStringTag,{value:"Module"})),$M=`<div class="grid grid-cols-[2fr_1fr] w-full h-full">
    <div class="relative border-bg-card pt-8 border-r h-full flex flex-col">
        <div class="absolute top-0 left-0 border-l-2 border-t-2 border-primary w-4 h-4"></div>
...
</div>`,ZM=Object.freeze(Object.defineProperty({__proto__:null,default:$M},Symbol.toStringTag,{value:"Module"})),JM=`<div class="grid grid-cols-[2fr_1fr] w-full h-full">
    <div class="relative border-bg-card pt-8 border-r h-full flex flex-col">
        <div class="absolute top-0 left-0 border-l-2 border-t-2 border-primary w-4 h-4"></div>
        <div class="pl-8 mb-5" id="title-container">
...
</div>`,QM=Object.freeze(Object.defineProperty({__proto__:null,default:JM},Symbol.toStringTag,{value:"Module"})),eS="/threejsportfolio/assets/prorer1-fE4xLF43.jpeg",tS=Object.freeze(Object.defineProperty({__proto__:null,default:eS},Symbol.toStringTag,{value:"Module"})),nS="/threejsportfolio/assets/prorer2-DdZDB9on.jpeg",iS=Object.freeze(Object.defineProperty({__proto__:null,default:nS},Symbol.toStringTag,{value:"Module"})),rS="/threejsportfolio/assets/prorer3-CZyTW0Qp.jpeg",sS=Object.freeze(Object.defineProperty({__proto__:null,default:rS},Symbol.toStringTag,{value:"Module"})),aS="/threejsportfolio/assets/prorer4-D0B-0BmB.jpeg",oS=Object.freeze(Object.defineProperty({__proto__:null,default:aS},Symbol.toStringTag,{value:"Module"})),rf=["!","@","#","$","%","^","&","*","(",")","-","_","+","=","{","}","[","]","|","\\",":",";",'"',"'","<",">",",",".","?","/"];async function Oa(r,e){const t=document.getElementById(e);if(!t)return;const n=1e3,i=Date.now();return new Promise(s=>{function a(){const l=Date.now()-i,c=Math.min(l/n,1),u=Math.floor(c*r.length),h=r.slice(0,u);if(c>=1){t.textContent=r,s();return}const f=r.length-u;let d="";for(let g=0;g<f;g++)d+=rf[Math.floor(Math.random()*rf.length)];t.textContent=h+d,requestAnimationFrame(a)}requestAnimationFrame(a)})}const fc=new N0;let Nr,ar={abortBoot:null,screenMeshMaterial:null,isOnDesktop:!1},ln=ar.isOnDesktop,Ja={state:!1};function lS(r,e,t,n,i,s,a={}){return Kd(a),a.resize=()=>window.existingResizeHandler(e,i),a.click=o=>window.existingClickHandler(o,r,i),a.controlLock=()=>hS(r),a.beforeUnload=()=>Wf(n,i,r),a.toggleDesktop=()=>dS(e,t,r),a.mousemove=o=>fS(o,s),a.loaded=()=>cS(),window.addEventListener("resize",a.resize,!1),window.addEventListener("click",a.click,!1),document.addEventListener("click",a.controlLock),document.addEventListener("beforeunload",a.beforeUnload),window.addEventListener("toggle-desktop",a.toggleDesktop),window.addEventListener("mousemove",a.mousemove),window.addEventListener("threejs-loaded",a.loaded),pS(),a}async function cS(){const r=document.getElementById("loading-screen");r.classList.add("opacity-0"),await Dn(800),r.remove(),uS()}async function uS(){await Dn(1500),document.getElementById("toast").classList.remove("translate-x-full"),document.getElementById("countdown").classList.add("animate-toast"),await Dn(400),Oa("You are here to leak redacted data. Make it quick.","transmission"),document.getElementById("countdown").addEventListener("animationend",r=>{const e=r.target.parentElement;e.classList.add("translate-x-full"),setTimeout(()=>e.remove(),800)})}function Kd(r){window.existingLoopId&&cancelAnimationFrame(window.existingLoopId),ar.abortBoot&&(ar.abortBoot.abort(),ar.abortBoot=null);const e=document.querySelector("canvas");if(e&&e.remove(),r){r.resize&&window.removeEventListener("resize",r.resize),r.click&&window.removeEventListener("click",r.click),r.controlLock&&document.removeEventListener("click",r.controlLock),r.beforeUnload&&document.removeEventListener("beforeunload",r.beforeUnload),r.toggleDesktop&&window.removeEventListener("toggle-desktop",r.toggleDesktop),r.mousemove&&window.removeEventListener("mousemove",r.mousemove),r.loaded&&window.removeEventListener("threejs-loaded",r.loaded);for(const t in r)delete r[t]}}window.existingResizeHandler=function(r,e){window.innerWidth<1024&&(window.location.href="access_denied.html"),r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),e.setSize(window.innerWidth,window.innerHeight),e.setPixelRatio(Math.min(window.devicePixelRatio,2))};window.existingClickHandler=function(r,e,t){if(!e.isLocked&&!ln||r.target!=t.domElement||Ja.state)return;const n=fc.intersectObjects(rs,!0);if(n.length>0){const i=n[0].object;i.userData.onClick&&i.userData.onClick(ar)}};function hS(r){ln||r.lock()}function fS(r,e){e.rawX=r.clientX,e.rawY=r.clientY,ln?(e.x=r.clientX/window.innerWidth*2-1,e.y=-(r.clientY/window.innerHeight*2-1)):(e.x=0,e.y=0)}async function dS(r,e,t){ln=!ln,ar.abortBoot=null,Ja.state=!0,Nr=null,ln?(so(),t.unlock()):(await jd(ar.screenMeshMaterial,!0),t.lock()),Fb(ln),FM(r,e,ln,Ja)}function pS(){document.getElementById("xButton").addEventListener("click",()=>Jd.closePage())}function mS(r,e){if(Ja.state||window.isOnSlide)return;fc.setFromCamera(r,e);const t=fc.intersectObjects(rs.filter(n=>n.visible));if(t.length>0){const n=t[0].object;if(n===Nr){if(!ln)return;so(),nf(ln,n,r);return}ln&&Yd(n),Nr=n,nf(ln,n,r)}else Nr!=null&&($d(),Nr=null)}function $d(){ln&&Yd(Nr,!0),so()}const xS={PRorER:{redacted:!0,title:"PRorER",short_bio:"Workout Logger and Optimizer",bio:"A sophistacted application that's designed to offer gym goers a free method to categorize, log and graph their workouts and personal records (PRs). Built using Flutter, Postgres, S3 Buckets and SupabaseAuth.",stack:["FLUTTER","FRONT-END","BACK-END","DB-ARCH","UI/UX"],source_btn:null,initialize:"unimplemented.html"}};async function Zd(r,e,...t){const n=document.getElementById(r);let i=t.indexOf(n.textContent);i=i==-1?0:i;const s=t[(i+1)%t.length];n.textContent=s,n.setAttribute("data-text",s),await Dn(e),requestAnimationFrame(()=>Zd(r,e,...t))}const gS=Object.assign({"/src/pages/About Me.html":KM}),_S=Object.assign({"/src/template-allowed.html":ZM,"/src/template-redacted.html":QM}),vS=Object.assign({"/src/PRorER/prorer1.jpeg":tS,"/src/PRorER/prorer2.jpeg":iS,"/src/PRorER/prorer3.jpeg":sS,"/src/PRorER/prorer4.jpeg":oS});function sf(){const r=document.getElementById("slide");r.classList.contains("translate-y-full")?r.classList.remove("translate-y-full"):r.classList.add("translate-y-full")}function bS(r){let t=Object.entries(gS).find(([n,i])=>n.split("/").at(-1).split(".")[0]===r);return t===void 0?SS(r):[null,t[1].default]}async function yS(r){r==="About Me"?(await Dn(450),Oa("In a world where everything is locked behind a micro transaction, people yearn for safety and silence. His mission is to bring that back to reality.","bio")):(await Dn(450),Oa("[ SYNOPSIS ]","synopsis"),Oa("[ STACK ]","stack"))}function MS(){Zd("redacted",2500,"CORRUPTED","UNKNOWN","0x_ERROR")}function SS(r){const t=Object.entries(xS).find(s=>s[0]==r);if(t==null)throw Error("Page not found");const n=t[1],i=Object.entries(_S);return n.redacted?[n,i.find(s=>s[0].includes("redacted"))[1].default]:[n,i.find(s=>s[0].includes("allowed"))[1].default]}function TS(r){const e=[];Object.entries(vS).forEach(([s,a])=>{s.includes(r)&&e.push(a.default)});const n=document.getElementById("carousel"),i=document.getElementById("img");i.setAttribute("src",e[0]),e.shift();for(const[s,a]of e.entries()){const o=i.cloneNode();o.setAttribute("src",a),o.setAttribute("id",s),n.append(o)}ES()}function ES(){const r=document.getElementById("carousel"),e=document.getElementById("closeimg");e.onclick=()=>{const t=document.getElementById("img-slide");t.classList.remove("-translate-y-1/2"),t.classList.add("translate-y-full")},r.onclick=t=>{const n=t.target;if(console.log(t.target.tagName),t.target.tagName!="IMG")return;const i=document.getElementById("img-slide");document.getElementById("slide image").setAttribute("src",n.getAttribute("src")),i.classList.remove("translate-y-full"),i.classList.add("-translate-y-1/2")}}function wS(r){const e=Object.entries(r),t=document.createElement("p");t.className="font-mono text-xs text-text-muted mb-2 select-none",t.textContent="[CLASSIFIED]";for(const[n,i]of e){if(n==="redacted"){i&&MS();continue}if(n==="initialize")if(i){document.getElementById("initialize").setAttribute("href",i);continue}else{document.getElementById("initialize").remove(),document.getElementById("title-container").prepend(t);continue}if(i){if(n==="stack"){for(const[s,a]of i.entries())document.getElementById(`stack-${s+1}`).textContent=a;continue}if(n=="source_btn"){document.getElementById(n).setAttribute("href",i);continue}document.getElementById(n).textContent=i}}}const Jd={openPage(r){window.isOnSlide=!0,$d();const[e,t]=bS(r),n=document.getElementById("pageContainer");n.innerHTML=t,sf(),e&&(TS(r),wS(e)),yS(r)},closePage(){sf(),window.isOnSlide=!1}},AS=Object.assign({"/src/icons/About Me.png":HM,"/src/icons/PRorER.png":XM,"/src/icons/Power.png":YM});function*RS(){const r=Object.values(AS);DS(r);for(const[e,t]of r.entries()){const n=t.default,i=n.split("/").at(-1).split(".")[0],s=new Dc().load(n),a=22,o=CS(i,s,a);o.userData.isIcon=!0,o.userData.onClick=LS(i.replaceAll("%20"," ")),o.name=i;const[l,c]=PS(e,15,a,4);o.position.set(l,-17,c),o.visible=!1,o.userData.scaleTween=IS(o,1,1.2),yield o}}function CS(r,e,t){const n=new to({color:9553841,map:e,emissiveMap:e,emissive:16777215,emissiveIntensity:.75}),i=new hr(t,t,t),s=new Qt(i,n);return s.name=r,s}function PS(r,e,t,n){const a=e+t,l=220-a*(r%n);return[Math.floor(r/n)*a+-135,l]}function LS(r){return r==="Power"?()=>window.dispatchEvent(new CustomEvent("toggle-desktop")):()=>Jd.openPage(r)}function DS(r){const e=r.indexOf(n=>n.default.contains("Power")),t=r.splice(e,1)[0];r.push(t)}function IS(r,e,t){return cr.fromTo(r.scale,{x:e,z:e},{paused:!0,x:t,z:t,overwrite:"auto"})}const rs=[];let Qd,Ds=rs.filter(r=>r.userData.isIcon),Is=Ds.map(r=>r.scale);function US(r){const e=Object.values(VM);for(const t of e)typeof t=="function"&&rs.push(t(r));for(const t of RS())rs.push(t),Xf(r,t,Oc);Qd=FS()}async function ep(){Is.some(r=>r.x>0)?await NS():await Qd.restart()}async function NS(){await cr.to(Is,{x:0,y:0,z:0,duration:1,stagger:.1,ease:"power3.inOut",onComplete:()=>{Ds.forEach(r=>r.visible=!1)}})}function FS(){return Ds=rs.filter(e=>e.userData.isIcon),Is=Ds.map(e=>e.scale),cr.set(Is,{x:0,y:0,z:0}),cr.to(Is,{x:1,y:1,z:1,paused:!0,duration:1,stagger:.1,ease:"back.out(1.7)",onStart:()=>{Ds.forEach(e=>e.visible=!0)}})}let ri;const tp="/threejsportfolio/";function OS(r,e){new qf(e).load(tp+"models/personal_computer/pc.glb",function(n){const i=n.scene.children[0];i.name=Oc,i.position.set(-7.9,.35,-1.87),i.rotation.z=-Math.PI/2,r.add(i),Gf(i),i.traverse(s=>{s.isMesh&&s.material.name==="Screen"&&HS(s)}),US(r)})}async function BS(){const r=document.createElement("canvas"),e=r.getContext("2d");Nb(r);const t=new i0(r);ri.color=new Ae(16777215),ri.emissive=new Ae(16777215),ri.map.dispose(),ri.map=t,ri.emissiveMap=t,t.colorSpace=Ct,t.flipY=!1,t.anisotropy=16,iu(r),e.fillStyle="white",t.magFilter=Dt,t.minFilter=Dt,e.imageSmoothingEnabled=!1,e.font=`${Wa}px VT323`;const n=new AbortController;return t.needsUpdate=!0,kS(t,e,r,n),[n,ri]}async function kS(r,e,t,n){const i=[];let s=14,a=qo[0];e.fillText(a,50,Wa+10),r.needsUpdate=!0,i.push({line:a,color:e.fillStyle});for(let o=0;o<qo.length;o++){if(await Dn(100+Math.random()*2e3),n.signal.aborted)return;let l=qo[o];o>=s&&(i.shift(),np(e,t,i));const c=WS(l,e);e.fillText(l,50,(Wa+10)*Math.min(o+1,s)),i.push({line:l,color:e.fillStyle}),r.needsUpdate=!0,await Dn(c)}zS(e,t,i,r,n)}function np(r,e,t){iu(e);for(let n=0;n<t.length;n++){let i=t[n];r.fillStyle=i.color,r.fillText(i.line,50,(Wa+10)*n+1)}}async function zS(r,e,t,n,i){let s=!1;for(let a=0;a<5;a++){if(await Dn(500),i.signal.aborted)return;s=!s,t[t.length-1]={line:`> ${s?"█":"_"}`,color:"white"},np(r,e,t),n.needsUpdate=!0}VS(r,e,n,i)}async function VS(r,e,t,n){if(n.signal.aborted)return;iu(e),r.fillStyle="white";let i="Loading StrikeOS...",s=r.measureText(i).width;r.textAlign="center",r.fillText(i,e.width/2,e.height/2),r.strokeStyle="cyan",r.lineWidth=5,r.strokeRect(e.width/2-s/2,e.height/2+50,s,80),t.needsUpdate=!0,r.fillStyle="cyan";let a=0;for(let o=1;o<=10;o++){if(await Dn(500*Math.random()),n.signal.aborted)return;a=o/10*s,r.fillRect(e.width/2-s/2,e.height/2+50,a,80),t.needsUpdate=!0}await GS()}async function GS(){const r=await new Dc().loadAsync(`${tp}pictures/pic.jpg`);r.flipY=!1,ri.map=r,ri.emissiveMap=r,ep(),window.dispatchEvent(new CustomEvent("toggle-desktop"))}function HS(r){const e=new St,t=new Un({map:e,emissiveMap:e,emissive:0,emissiveIntensity:.3,color:0,side:En,clearcoat:.5});r.material=t,ri=t}function WS(r,e){switch(r.slice(3,r.indexOf("]"))){case"WARN":return e.fillStyle="#ff9100ff",700;case"CRIT":return e.fillStyle="red",700;case"FIX":return e.fillStyle="green",0;default:return e.fillStyle="white",0}}function iu(r){const e=r.getContext("2d");e.fillStyle="black",e.fillRect(0,0,r.width,r.height)}const XS="/threejsportfolio/";function qS(r,e){new qf(e).load(XS+"models/empty_office_space/office.glb",function(n){const i=n.scene;i.position.set(-8.2,-.5,-1.7),r.add(i),Gf(i)})}function YS(r,e,t,n,i){r.background=new Ae(11184810),e.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(e.domElement),t.movementSpeed=0,t.lookSpeed=.1,t.maxPolarAngle=Math.PI*3/4,t.minPolarAngle=Math.PI/4;const s=new Ff(16777215,1);s.position.set(0,10,-2);const a=new _0(16777215,16777215);a.position.set(0,10,0),r.add(s),r.add(a),r.add(i),n.position.set(-8.97,.8,-1.95),i.lookAt(Bc.desktopLookVector),n.lookAt(-7.9,.8,-1.87)}let Ki,dc,$i,Qi,Aa,rl;const Rn="__THREE_APP_CONTEXT__";if(window[Rn]){console.log("Cleaning up previous context...");const r=window[Rn];r.loopId&&cancelAnimationFrame(r.loopId),Kd(r.listeners),NM(),Wf(r.scene,r.renderer,r.controls,r.gui),window[Rn]=null}window[Rn]={renderer:null,scene:null,camera:null,controls:null,loopId:null,listeners:{}};jS();async function jS(){Ki=new Sb({antialias:!0}),window[Rn].renderer=Ki,Ki.setPixelRatio(Math.min(window.devicePixelRatio,2)),dc={x:0,y:0,rawX:0,rawY:0},$i=new Wm,window[Rn].scene=$i,Qi=new Ft(75,window.innerWidth/window.innerHeight,.1,1e3),window[Rn].camera=Qi,Aa=new Ab(Qi,Ki.domElement),window[Rn].controls=Aa,rl=OM(Bc.desktopLocationVector),lS(Aa,Qi,rl,$i,Ki,dc,window[Rn].listeners),ip(),await Db(),YS($i,Ki,Aa,Qi,rl);const r=new Uf;r.onLoad=function(){window.dispatchEvent(new CustomEvent("threejs-loaded"))},qS($i,r),OS($i,r)}function ip(){mS(dc,Qi),Ki.render($i,Qi);const r=requestAnimationFrame(ip);window[Rn]&&(window[Rn].loopId=r)}async function pc(r,e,t){const n=document.getElementById(e);if(!n)return;const i=n.textContent.split("").filter(s=>s==".").length;if(await Dn(500),i===r||t&&i!=0){n.textContent=n.textContent.replace(".",""),pc(r,e,!0);return}n.textContent=n.textContent+".",pc(r,e)}pc(3,"loading-text");const rp=document.getElementById("hitmarkerText");rp.style.backdropFilter="blur(4px)";rp.style.backgroundColor="rgba(59, 59, 59, 0.9)";
